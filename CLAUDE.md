...
| Animation Pose Re-Anchoring | `handlers/animation.py` + `utils/anim_math.py` + `mcp-server/src/tools/animation.ts` | Passes 1-2 plus the Pass 4 dry run; all read-only, Passes 1-2 run live | `docs/superpowers/specs/2026-07-28-anim-pose-reanchor-design.md` |
