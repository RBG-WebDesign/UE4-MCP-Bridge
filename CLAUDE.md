...
| Animation Pose Re-Anchoring | `handlers/animation.py` + `utils/anim_math.py` + `Source/.../AnimPose/` + `mcp-server/src/tools/animation.ts` | All passes written; Passes 1-2 run live, Pass 3 C++ never compiled | `docs/superpowers/specs/2026-07-28-anim-pose-reanchor-design.md` |
