...
const allPermissions: readonly Permission[] = [
  ...
  "project.config.read", "project.config.write", "pie.observe",
...
export const toolDefinitions: readonly ToolDefinition[] = [
  ...
  // Slower than a read: every added mapping flushes DefaultInput.ini through
  // the library, and a preset is eleven of them.
