...
const commandTimeouts: Readonly<Record<string, number>> = {
  ...
  // Every added mapping flushes Config/DefaultInput.ini through the library,
  // and a preset is eleven of them, so the 7 second default is close enough to
  // the real cost to report a failure for work that succeeded.
