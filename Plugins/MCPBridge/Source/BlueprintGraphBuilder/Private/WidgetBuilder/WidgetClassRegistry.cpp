...
void FWidgetClassRegistry::RegisterTypes()
{
	...
	TextBlockInfo.SupportedProperties.Add({TEXT("fontSize"), EJson::Number});
	TextBlockInfo.SupportedProperties.Add({TEXT("autoWrapText"), EJson::Boolean});
	TextBlockInfo.SupportedProperties.Add({TEXT("shadowOffset"), EJson::Object});
	TextBlockInfo.SupportedProperties.Add({TEXT("shadowColor"), EJson::Object});
	...
	BorderInfo.SupportedProperties.Add({TEXT("color"), EJson::Object});
	BorderInfo.SupportedProperties.Add({TEXT("padding"), EJson::Object});
