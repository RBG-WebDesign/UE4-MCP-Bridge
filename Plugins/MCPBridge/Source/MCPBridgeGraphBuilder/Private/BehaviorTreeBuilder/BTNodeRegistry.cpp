...
bool FBTNodeRegistry::IsParamAllowed(const FString& Type, const FString& Param) const
{
	static const TMap<FString, TSet<FString>> Allowed = {
		{ TEXT("Selector"), {} }, { TEXT("Sequence"), {} }, { TEXT("SimpleParallel"), { TEXT("finish_mode") } },
		{ TEXT("MoveTo"), { TEXT("blackboard_key"), TEXT("acceptable_radius") } },
		{ TEXT("Wait"), { TEXT("wait_time"), TEXT("random_deviation") } },
		{ TEXT("WaitBlackboardTime"), { TEXT("blackboard_key") } }, { TEXT("RotateToFaceBBEntry"), { TEXT("blackboard_key") } },
		{ TEXT("PlayAnimation"), { TEXT("non_blocking"), TEXT("looping") } }, { TEXT("MakeNoise"), { TEXT("loudness") } },
		{ TEXT("RunBehavior"), {} }, { TEXT("PlaySound"), { TEXT("sound_to_play") } }, { TEXT("FinishWithResult"), { TEXT("result") } },
		...
		{ TEXT("IsBBEntryOfClass"), { TEXT("blackboard_key"), TEXT("test_class") } }, { TEXT("DefaultFocus"), { TEXT("blackboard_key") } }
	};
	...
	else if (Type == TEXT("DoesPathExist"))
	{
		...
		if (const FString* QueryType = Merged.Find(TEXT("path_query_type")))
		{
			...
			if (QProp)
			{
				...
				if (QPtr)
				{
					if (*QueryType == TEXT("NavMesh"))                *QPtr = static_cast<uint8>(EPathExistanceQueryType::NavmeshRaycast2D);
					else if (*QueryType == TEXT("HierarchicalQuery")) *QPtr = static_cast<uint8>(EPathExistanceQueryType::HierarchicalQuery);
				}
			}
		}
		if (const FString* Inverse = Merged.Find(TEXT("inverse_condition")))
